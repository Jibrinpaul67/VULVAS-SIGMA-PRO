    ...
    <div className="flex flex-col md:flex-row items-center justify-center p-4 sm:p-8 space-y-6 md:space-y-0 md:space-x-4">
      <div className="text-center md:text-left w-full md:w-[45%]">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
          ...
          <span className="text-black">Privacy Commitment</span>
        </h1>
        <p className="text-gray-600 text-base sm:text-lg mt-3 sm:mt-4">
          VULAS commits to protecting user data through encryption,
           strict access controls, and compliance with privacy regulations. This policy 
          tells you what information we collect from you and what we do with it.
        </p>
      </div>
