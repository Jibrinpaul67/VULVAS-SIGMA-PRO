...
const Pricing = () => {
  ...
  const plans = [
    { name: "Individual", price: 30000, devices: "1-5 Devices per year", isCustom: false },
    { name: "Enterprise", price: 55000, devices: "6-20 Devices per year", isCustom: false },
    { name: "Institutional", price: 80000, devices: "21-50 Devices per year", isCustom: false },
    { name: "Corporate", price: 160000, devices: "51-100 Devices per year", isCustom: false },
